...
for vertI = 1 : 4
    ...
    faceVect4 = botVertIndex( vertI );
    faceVect5 = botVertIndex( mod(vertI,4)+1 );
    faceVect6 = topVertIndex( mod(vertI,4)+1 );
	faces = [ faces ; faceVert1 faceVert2 faceVert3; faceVect4 faceVect5 faceVect6];
end
